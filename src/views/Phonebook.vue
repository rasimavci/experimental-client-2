...
export default {
  ...
  methods: {
    ...
    getFolderContents () {
      this.items = [{ contact: 'rasim',
        initial: 'a',
        number: '1',
        items: [1],
        selectedItem: ''}, { contact: 'ramis',
          initial: 'a',
          number: '2',
          items: [1],
          selectedItem: ''}, { contact: 'Erdem Saliohğlu',
            initial: 's',
            number: '2',
            items: [1],
            selectedItem: ''}, { contact: 'barkın elmacıoğlu',
              initial: 'e',
              number: '2',
              items: [1],
              selectedItem: ''}, { contact: 'rasim',
                initial: 'a',
                number: '1',
                items: [1],
                selectedItem: ''}, { contact: 'ramis',
